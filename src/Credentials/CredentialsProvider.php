...
class CredentialsProvider
{
    ...
    public static function env()
    {
        return function () {
            ...
            // ***** BEGIN ***** CredentialsProvider.php *** added my code for Token access from my Database
            
            $appIdTOKENObject = DB::table('tokenebay')->select('token')->where('id', 1)->get();
            echo "ebayitemcheck token is: ";
            echo $appIdTOKENObject[0]->token;
            $appIdTOKEN = $appIdTOKENObject[0]->token;
   
            $appId = $appIdTOKEN;            
            // $appId = getenv(self::ENV_APP_ID);
            
            // ***** END ***** CredentialsProvider.php *** added my code for Token access from my Database
